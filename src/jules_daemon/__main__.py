...
def _load_dotenv_if_available() -> None:
    ...
    This intentionally does not depend on ``python-dotenv``. Jules only needs
    simple ``KEY=value`` startup configuration here, and repo-local values
    should override stale inherited shell variables when the daemon is launched
